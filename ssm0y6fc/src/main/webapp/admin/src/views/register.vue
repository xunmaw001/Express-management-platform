      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='peisongyuan'" class="input-group">
			   <div class="label">配送账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.peisongzhanghao" class="input" type="text" placeholder="配送账号">
			   </div>
			 </div> -->
			<el-form-item label="配送账号" class="input" v-if="tableName=='peisongyuan'">
			  <el-input v-model="ruleForm.peisongzhanghao" autocomplete="off" placeholder="配送账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='peisongyuan'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<!-- <div v-if="tableName=='peisongyuan'" class="input-group">
			   <div class="label">配送员</div>
			   <div class="input-container">
			     <input v-model="ruleForm.peisongyuan" class="input" type="text" placeholder="配送员">
			   </div>
			 </div> -->
			<el-form-item label="配送员" class="input" v-if="tableName=='peisongyuan'">
			  <el-input v-model="ruleForm.peisongyuan" autocomplete="off" placeholder="配送员"  />
			</el-form-item>
			<!-- <div v-if="tableName=='peisongyuan'" class="input-group">
			   <div class="label">配送员手机</div>
			   <div class="input-container">
			     <input v-model="ruleForm.peisongyuanshouji" class="input" type="text" placeholder="配送员手机">
			   </div>
			 </div> -->
			<el-form-item label="配送员手机" class="input" v-if="tableName=='peisongyuan'">
			  <el-input v-model="ruleForm.peisongyuanshouji" autocomplete="off" placeholder="配送员手机"  />
			</el-form-item>
			<!-- <div v-if="tableName=='peisongyuan'" class="input-group">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.peisongyuan) && `peisongyuan` == this.tableName){
        this.$message.error(`配送员不能为空`);
        return
      }
      if(`peisongyuan` == this.tableName && this.ruleForm.peisongyuanshouji&&(!this.$validate.isMobile(this.ruleForm.peisongyuanshouji))){
        this.$message.error(`配送员手机应输入手机格式`);
        return
      }
