<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="快递位置" prop="kuaidiweizhi">
          <el-input v-model="ruleForm.kuaidiweizhi" 
              placeholder="快递位置" clearable  :readonly="ro.kuaidiweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="快递位置" prop="kuaidiweizhi">
              <el-input v-model="ruleForm.kuaidiweizhi" 
                placeholder="快递位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="配送物流" prop="peisongwuliu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="配送物流"
                  v-model="ruleForm.peisongwuliu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.peisongwuliu" label="配送物流" prop="peisongwuliu">
                    <span>{{ruleForm.peisongwuliu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.peisongyuan!=''&&json.peisongyuan){
                this.ruleForm.peisongyuan = json.peisongyuan
	    		this.ro.peisongyuan = true;
		}
		if(json.peisongyuanshouji!=''&&json.peisongyuanshouji){
                this.ruleForm.peisongyuanshouji = json.peisongyuanshouji
	    		this.ro.peisongyuanshouji = true;
		}
