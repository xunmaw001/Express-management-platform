    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="物流" prop="wuliu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.wuliu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wuliu" label="物流" prop="wuliu">
                    <span v-html="ruleForm.wuliu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.wuliu = this.ruleForm.wuliu.replace(reg,'../../../ssm0y6fc/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
