<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="完成时间" prop="wanchengshijian">
          <el-input v-model="ruleForm.wanchengshijian" 
              placeholder="完成时间" clearable  :readonly="ro.wanchengshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="完成时间" prop="wanchengshijian">
              <el-input v-model="ruleForm.wanchengshijian" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="配送评价" prop="peisongpingjia">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="配送评价"
                  v-model="ruleForm.peisongpingjia" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.peisongpingjia" label="配送评价" prop="peisongpingjia">
                    <span>{{ruleForm.peisongpingjia}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `querenwancheng/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.querenwanchengCrossAddOrUpdateFlag = false;
						 this.parent.search();
