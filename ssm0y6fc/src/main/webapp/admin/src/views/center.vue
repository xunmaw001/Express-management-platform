  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='peisongyuan'"  label="配送账号" prop="peisongzhanghao">
          <el-input v-model="ruleForm.peisongzhanghao" readonly              placeholder="配送账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='peisongyuan'"  label="配送员" prop="peisongyuan">
          <el-input v-model="ruleForm.peisongyuan"               placeholder="配送员" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='peisongyuan'"  label="配送员手机" prop="peisongyuanshouji">
          <el-input v-model="ruleForm.peisongyuanshouji"               placeholder="配送员手机" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.peisongyuan)&& 'peisongyuan'==this.flag){
      ...
      if( 'peisongyuan' ==this.flag && this.ruleForm.peisongyuanshouji&&(!isMobile(this.ruleForm.peisongyuanshouji))){
